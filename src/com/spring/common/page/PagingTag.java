...
public class PagingTag extends TagSupport {
	...
	public String getPaging(){
		...
		/*lastPage총 페이지 수는  total이 11이고 list_size가 10이면 1을 가진다 
		 * 그래서 총 페이지 수가 누나어 떨어지징 ㅏㄶ으면나머지 레코드를 출력 할 페이지가 필요하다는 의미.*/
		
		if(total%list_size !=0) lastPage = lastPage  +1;
		
		/*currentlast가  lastPage촐 페이지 수보다 크면 마지막 페이지로 수정 */
